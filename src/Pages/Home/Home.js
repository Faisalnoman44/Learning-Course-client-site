...
const Home = () => {
    return (
        <div className='md:w-11/12  mx-auto mt-2'>
            ...
            <p className='text-center mt-3'><span className='text-lg font-semibold text-blue-700'>To see couse </span><Link to='/courses'><button className="btn btn-outline btn-success">Click here</button></Link></p>
        </div>
    );
};
